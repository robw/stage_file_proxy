A Drupal 7 port of stage_file_proxy (http://drupal.org/project/stage_file_proxy).
...
This module is only tested using Apache 2 on Mac OS X and Linux. You should not need to have this module enabled in production. It also assumes, for now, that you have the same relative path (e.g. '/files' or /sites/default/files') on both production and development environments.
